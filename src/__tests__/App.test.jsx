...
describe('<App />', () => {
    ...
    it('will title be displayed when click on "Show title"', () => {
        ...
        app.find('button.show').simulate('click');
        expect(app.contains(<h1 className="title">Hello world</h1>)).toEqual(true);
        // app.find('button.hide').simulate('click');
        // expect(app.contains(<h1 className="title">Hello world</h1>)).toEqual(false);
    });
});